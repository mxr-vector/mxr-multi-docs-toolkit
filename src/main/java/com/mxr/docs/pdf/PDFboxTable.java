...
public class PDFboxTable {
    private static final String path = System.getProperty("user.dir") + File.separator + "assets" + File.separator + "pdf" + File.separator + "struct_mapping_test1.pdf";
